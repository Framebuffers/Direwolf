...
{
    /// <summary>
    ///     Sends a signal to <see cref="Direwolf" /> that the process has been completed, to pass control to the serialization
    ///     routines.
    /// </summary>
    public event EventHandler<HuntCompletedEventArgs>? HuntCompleted;

    /// <summary>
    ///     Raw information obtained from a query. The results in <see cref="Wolfpack.Results" /> is the serialized content of
    ///     Den.
    /// </summary>
    ...
    ///     given <see cref="IWolf" />, and enqueues the resulting Wolf to the WolfQueue.
    /// </summary>
    ...
    /// <summary>
    ///     Performs the query. Summons all the workers held in <see cref="WolfQueue" />, executes the <see cref="IWolf.Run" />
    ///     method inside each other, and waits back for them to come back.
