...
namespace Direwolf.Revit.Howls.Legacy
{
    public record class _GetElementInformation : RevitHowl
    {
        public _GetElementInformation(Document doc) => SetRevitDocument(doc);
