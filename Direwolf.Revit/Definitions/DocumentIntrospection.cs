 ...
 * Author: Framebuffer
 * Date  : 2025-03-20
 * _Direwolf Query Architecture
 *
 * I need to explain a couple of things to *understand* some of my decisions within _Direwolf.
 *
 ...
 *
 * One more thing: but Frame, what does _Direwolf do for me? This is where Introspection comes.
 ...
 *
 * Introspection works by querying Elements in such a way where Revit gives a valid range of Elements, _Direwolf sieves them by: CategoryType, Category, Family, Element, a Dictionary of Parameters. _Direwolf *abstracts* these to records, just like Revit, to the important bits, whilst also leaving room to add more.
 *
