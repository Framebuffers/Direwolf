...
public class NativeRevitCommand : DirewolfRevitCommand
{
    ...
    public override Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        try
        {
            ProcessInfo(commandData.Application.ActiveUIDocument.Document);
    ...
    private void ProcessInfo(Document doc)
    {
        s.Start();
        _warns.AddRange(doc.GetWarnings());
        ...
        s.Stop();
        Debug.Print($"\nNativeRevitCommand_time: {s.Elapsed.Seconds}");
    }
