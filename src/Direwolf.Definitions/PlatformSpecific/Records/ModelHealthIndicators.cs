...
public record ModelHealthIndicators
{
    ...
    public static Wolfpack Create(Document document, IEnumerable<Element> elementsToCheck)
    {
        ...
        return new Wolfpack(Cuid.CreateRevitId(document, out _).Value!, RequestType.Get, "ModelHealthIndicators", WolfpackParams.Create(howl, "wolfpack://com.revit.autodesk-2025.4/direwolf/custom?t=ModelHealthIndicators"), [Howl.AsPayload(howl with {Result = ResultType.Accepted})], "Model Health Indicators");
    }
