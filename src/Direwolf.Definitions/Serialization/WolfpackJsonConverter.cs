...
//                         case "MessageType":
//                             if (string.IsNullOrEmpty(reader.GetString()))
//                                 throw new JsonException($"{nameof(MessageType)} is empty.");
//                             if (!Enum.TryParse<MessageType>(reader.GetString()!, true, out var method))
//                                 throw new JsonException($"{nameof(MessageType)} is not a valid requestType.");
//                             m = method;
//                             break;
//                         case "ArgumentName":
//                             if (string.IsNullOrEmpty(reader.GetString()))
...
//                                 {
//                                     var howl = JsonSerializer.Deserialize<Wolfpack>(ref reader, options);
//                                     payload?.Add(howl);
//                                 }
//
//                             break;
