...
/// <summary>
///     Defines the return state of any given transaction. It mirrors Revit's internal Result enum, but includes
///     an additional value: <see cref="TransactionResult.ExceptionThrown" />. It helps Direwolf process the failure
///     state of any given query instead of just assuming the operation failed and carry on.
/// </summary>
public enum TransactionResult
{
    ...
    // any transaction that has thrown an Exception *must* be returned inside the Data field
