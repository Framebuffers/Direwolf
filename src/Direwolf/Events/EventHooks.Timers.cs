    ...
    private void AddTimeIntervalCheck(Realm op, EventCondition eventCondition)
    {
        switch (op)
        {
            case Realm.Query:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _direwolfQueryOperationTimer
            ...
            case Realm.Set:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _direwolfSetOperationTimer.Elapsed
                                                  .TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.InternalDatabase:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _direwolfInternalOperationTimer
                                                  .Elapsed.TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.Parameter:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _parameterOperationTimer.Elapsed
                                                  .TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.Instances:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _instancesOperationTimer.Elapsed
                                                  .TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.Element:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _elementOperationTimer.Elapsed
                                                  .TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.ElementType:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _elementTypeOperationTimer.Elapsed
                                                  .TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.Schedule:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _scheduleOperationTimer.Elapsed
                                                  .TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.Category:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _categoryOperationTimer.Elapsed
                                                  .TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.Document:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _documentOperationTimer.Elapsed
                                                  .TotalMilliseconds));
                Debug.Print(
            ...
            case Realm.RevitUIApplication:
                ...
                Timers.Add(new TimerEventData(op,
                                              eventCondition,
                                              DateTime.Now,
                                              _revitUIApplicationOperationTimer
                                                  .Elapsed.TotalMilliseconds));
                Debug.Print(
